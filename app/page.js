...
import { Search, MessageCircle, Home as HomeIcon, CheckCircle } from "lucide-react";

export default function Home() {
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#000000] font-['Poppins']">
      {/* Navbar */}
      <nav className="sticky top-0 z-50 bg-[#ffffff] border-b-[1px] border-[#cecaca] px-[50px] py-[29px] flex justify-between items-center">
        <div className="font-['freight-big-pro'] font-[900] text-[29px] text-[#000000]">Apex Realty</div>
        <div className="flex gap-[38px] font-['niveau-grotesk'] text-[#000000]">
        ...
        <button className="bg-[#8d2926] text-[#ffffff] px-[29px] py-[1px] h-[43px] rounded-[5px] font-['Roboto'] font-[500] hover:bg-[#c02b0a] transition-colors duration-[200ms]">
          List Your Home
        </button>
      </nav>
      ...
      <main>
        {/* Hero */}
        <section className="px-[50px] py-[80px] grid grid-cols-2 gap-[80px] items-center">
          <div className="flex flex-col gap-[35px]">
            <div>
              <span className="text-[#8d2926] font-['Roboto'] font-[500] uppercase tracking-wider text-[14px]">Premier Real Estate Agency</span>
              <h1 className="font-['freight-big-pro'] font-[900] text-[71px] leading-[1.1] mt-[29px]">Find Your Dream Home</h1>
            </div>
            <p className="font-['Poppins'] font-[300] text-[#404042] text-[18px] leading-relaxed">
            ...
            {/* Stats */}
            <div className="flex gap-[38px] pt-[35px] border-t-[1px] border-[#cecaca] mt-[29px]">
              <div>
                <div className="font-['freight-big-pro'] font-[900] text-[29px]">8,500+</div>
                <div className="font-['Roboto'] text-[#888989] text-[14px]">Properties</div>
              </div>
              <div>
                <div className="font-['freight-big-pro'] font-[900] text-[29px]">4,200+</div>
                <div className="font-['Roboto'] text-[#888989] text-[14px]">Happy Clients</div>
              </div>
              <div>
                <div className="font-['freight-big-pro'] font-[900] text-[29px]">15+</div>
                <div className="font-['Roboto'] text-[#888989] text-[14px]">Years Experience</div>
              </div>
            </div>
          </div>
          
          <div className="relative">
            <img src="/images/hero-home.jpeg" alt="Hero Home" className="w-full h-[600px] object-cover rounded-[10px]" />
            <div className="absolute bottom-[29px] left-[-38px] bg-[#ffffff] p-[29px] rounded-[10px] border-[1px] border-[#cecaca]">
              <div className="font-['Roboto'] text-[#888989] text-[12px] uppercase">Avg. Home Value</div>
              <div className="font-['freight-big-pro'] font-[900] text-[29px] mt-[1px]">$620,000</div>
              <div className="text-[#8d2926] font-['Roboto'] font-[500] mt-[1px]">↑ 8.4% this year</div>
            </div>
          </div>
        </section>

        {/* Promo Banner */}
        <section className="bg-[#8d2926] px-[50px] py-[38px] text-white">
          <div className="grid grid-cols-3 gap-[38px] items-center">
            {/* Left */}
            <div className="flex flex-col">
              <span className="font-['freight-big-pro'] italic text-[35px] leading-none">Find your Center</span>
              <span className="text-[12px] font-['Roboto'] tracking-widest uppercase mt-[1px]">SALE</span>
            </div>
            {/* Center */}
            <div className="flex flex-col gap-[1px]">
              <h3 className="font-['freight-big-pro'] font-[900] text-[29px]">The 2026 Summer Sales Event!</h3>
        ...
        {/* Search Bar */}
        <section className="px-[50px] py-[43px]">
          <div className="bg-[#f3f3f3] rounded-[10px] p-[38px] flex gap-[29px] items-end">
            <div className="flex-1 flex flex-col gap-[1px]">
              <label className="font-['Roboto'] text-[14px] text-[#404042] mb-[1px]">Looking For</label>
              <select className="w-full h-[50px] border-[1px] border-[#cecaca] rounded-[5px] px-[29px] font-['Poppins'] font-[300] bg-[#ffffff]">
                <option>Buy</option>
                <option>Rent</option>
              </select>
            </div>
            <div className="flex-1 flex flex-col gap-[1px]">
              <label className="font-['Roboto'] text-[14px] text-[#404042] mb-[1px]">Property Type</label>
              <select className="w-full h-[50px] border-[1px] border-[#cecaca] rounded-[5px] px-[29px] font-['Poppins'] font-[300] bg-[#ffffff]">
                <option>Any</option>
                <option>House</option>
            ...
            <div className="flex-1 flex flex-col gap-[1px]">
              <label className="font-['Roboto'] text-[14px] text-[#404042] mb-[1px]">Location</label>
              <input type="text" placeholder="City, Neighborhood, or Zip" className="w-full h-[50px] border-[1px] border-[#cecaca] rounded-[5px] px-[29px] font-['Poppins'] font-[300] bg-[#ffffff]" />
            </div>
            <div className="flex-1 flex flex-col gap-[1px]">
              <label className="font-['Roboto'] text-[14px] text-[#404042] mb-[1px]">Budget</label>
              <select className="w-full h-[50px] border-[1px] border-[#cecaca] rounded-[5px] px-[29px] font-['Poppins'] font-[300] bg-[#ffffff]">
            ...
            <button className="bg-[#8d2926] text-[#ffffff] px-[38px] h-[50px] rounded-[5px] font-['Roboto'] font-[500] hover:bg-[#c02b0a] transition-colors duration-[200ms]">
              Get Results
            </button>
          </div>
        </section>
        ...
        {/* Featured Listings */}
        <section className="px-[50px] py-[80px]">
          <h2 className="font-['freight-big-pro'] font-[900] text-[50px] mb-[60px] text-center">Properties For You</h2>
          <div className="grid grid-cols-3 gap-[38px]">
            ...
            <div className="bg-[#ffffff] border-[1px] border-[#cecaca] rounded-[10px] overflow-hidden hover:border-[#8d2926] transition-colors duration-[300ms] group cursor-pointer">
              <div className="h-56 w-full relative">
                ...
                <div className="absolute top-[29px] left-[29px] bg-[#8d2926] text-[#ffffff] px-[29px] py-[1px] h-[29px] rounded-[2px] font-['Roboto'] font-[500] text-[12px] flex items-center">For Sale</div>
              </div>
              <div className="p-[38px] flex flex-col gap-[29px]">
                <div>
                ...
                <div className="font-['freight-big-pro'] font-[900] text-[35px] text-[#8d2926]">$1,250,000</div>
                <div className="font-['Roboto'] font-[400] text-[#888989] flex gap-[29px] text-[14px]">
                  <span>4 Bed</span>
                  <span>3 Bath</span>
            ...
            <div className="bg-[#ffffff] border-[1px] border-[#cecaca] rounded-[10px] overflow-hidden hover:border-[#1a73e8] transition-colors duration-[300ms] group cursor-pointer">
              <div className="h-56 w-full relative">
                ...
                <div className="absolute top-[29px] left-[29px] bg-[#8d2926] text-[#ffffff] px-[29px] py-[1px] h-[29px] rounded-[2px] font-['Roboto'] font-[500] text-[12px] flex items-center">For Rent</div>
              </div>
              <div className="p-[38px] flex flex-col gap-[29px]">
                <div>
                ...
                <div className="font-['freight-big-pro'] font-[900] text-[35px] text-[#8d2926]">$8,500/mo</div>
                <div className="font-['Roboto'] font-[400] text-[#888989] flex gap-[29px] text-[14px]">
                  <span>2 Bed</span>
                  <span>2 Bath</span>
            ...
            <div className="bg-[#ffffff] border-[1px] border-[#cecaca] rounded-[10px] overflow-hidden hover:border-[#8d2926] transition-colors duration-[300ms] group cursor-pointer">
              ...
              <div className="p-[38px] flex flex-col gap-[29px]">
                ...
                <div className="font-['freight-big-pro'] font-[900] text-[35px] text-[#8d2926]">$2,800,000</div>
                <div className="font-['Roboto'] font-[400] text-[#888989] flex gap-[29px] text-[14px]">
                  <span>5 Bed</span>
                  <span>5 Bath</span>
        ...
        {/* Stats Strip */}
        <section className="bg-[#000000] text-[#ffffff] py-[60px] px-[50px]">
          <div className="grid grid-cols-4 gap-[50px] text-center">
            <div className="flex flex-col gap-[1px]">
              <div className="font-['freight-big-pro'] font-[900] text-[50px]">8,500+</div>
              <div className="font-['Poppins'] font-[300] text-[#cecaca]">Properties</div>
            </div>
            <div className="flex flex-col gap-[1px]">
              <div className="font-['freight-big-pro'] font-[900] text-[50px]">97%</div>
              <div className="font-['Poppins'] font-[300] text-[#cecaca]">Client Satisfaction</div>
            </div>
            <div className="flex flex-col gap-[1px]">
              <div className="font-['freight-big-pro'] font-[900] text-[50px]">$4.2B+</div>
              <div className="font-['Poppins'] font-[300] text-[#cecaca]">Transactions Closed</div>
            </div>
            <div className="flex flex-col gap-[1px]">
              <div className="font-['freight-big-pro'] font-[900] text-[50px]">38</div>
        ...
        {/* How It Works */}
        <section className="bg-[#f3f3f3] py-[80px] px-[50px]">
          <h2 className="font-['freight-big-pro'] font-[900] text-[50px] mb-[65px] text-center">How It All Works</h2>
        ...
        {/* Testimonials */}
        <section className="bg-[#ffffff] py-[80px] px-[50px]">
          <h2 className="font-['freight-big-pro'] font-[900] text-[50px] mb-[65px] text-center">What Our Clients Say</h2>
          <div className="grid grid-cols-3 gap-[38px]">
            {/* Testimonial 1 */}
            <div className="border-[1px] border-[#cecaca] rounded-[10px] p-[50px] flex flex-col gap-[29px]">
              ...
              <div className="flex items-center gap-[29px]">
                <div className="w-[50px] h-[50px] rounded-[50px] bg-[#8d2926] text-[#ffffff] flex items-center justify-center font-['Roboto'] font-[500]">JS</div>
                <div>
            ...
            <div className="border-[1px] border-[#cecaca] rounded-[10px] p-[50px] flex flex-col gap-[29px]">
              ...
              <div className="flex items-center gap-[29px]">
                <div className="w-[50px] h-[50px] rounded-[50px] bg-[#8d2926] text-[#ffffff] flex items-center justify-center font-['Roboto'] font-[500]">ML</div>
                <div>
            ...
            <div className="border-[1px] border-[#cecaca] rounded-[10px] p-[50px] flex flex-col gap-[29px]">
              ...
              <div className="flex items-center gap-[29px]">
                <div className="w-[50px] h-[50px] rounded-[50px] bg-[#8d2926] text-[#ffffff] flex items-center justify-center font-['Roboto'] font-[500]">CW</div>
                <div>
        ...
        {/* CTA Section */}
        <section className="bg-[#8d2926] text-[#ffffff] py-[86px] px-[50px] text-center flex flex-col items-center gap-[35px]">
          <h2 className="font-['freight-big-pro'] font-[900] text-[60px]">Ready To Find Your Next Home?</h2>
          <p className="font-['Poppins'] font-[300] text-[20px] max-w-[600px] text-opacity-90">
      ...
      {/* Footer */}
      <footer className="bg-[#000000] py-[65px] px-[50px]">
        <div className="flex justify-between pb-[65px] border-b-[1px] border-[#404042]">
          <div className="w-[300px]">
            <div className="font-['freight-big-pro'] font-[900] text-[35px] text-[#ffffff] mb-[29px]">Apex Realty</div>
        ...
        <div className="pt-[38px] text-center font-['Roboto'] font-[300] text-[#888989] text-[14px]">
